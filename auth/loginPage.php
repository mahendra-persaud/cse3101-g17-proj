    ...
    <div class="glass-card">
      <form method="post" action="login.php">
        ...
        <p class="register-link">
          Don't have an account? &nbsp <a href="<?php echo $projectRoot; ?>/auth/register.php">Register here</a>
        </p>

        <p class = "terms-conditions">
          Terms and Conditions &nbsp <a href="<?php echo $projectRoot; ?>/school/terms.php"> Privacy Policy</a>
        </p>
      </form>
    </div>
  </div>
